...
import { Search, Filter, Calculator, Sparkles, Scale, Info, CheckCircle2, ChevronRight, Tag } from 'lucide-react';
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12 space-y-12">
      ...
      <div className="bg-gradient-to-r from-emerald-800 to-teal-900 rounded-3xl p-6 sm:p-8 text-white shadow-xl">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-center">
          ...
          <div className="lg:col-span-6 bg-white rounded-2xl p-5 text-slate-800 shadow-lg space-y-4">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              <div>
                ...
                <select
                  ...
                  className="w-full text-xs sm:text-sm p-2.5 rounded-xl border border-slate-200 focus:outline-none focus:ring-2 focus:ring-emerald-500 font-medium"
                >
            ...
            <div className="p-3 bg-emerald-50 rounded-xl border border-emerald-200 flex items-center justify-between">
              <div>
                <span className="text-[11px] text-emerald-700 font-semibold block">Estimasi Saldo yang Masuk:</span>
                <span className="text-xl sm:text-2xl font-extrabold text-emerald-800 font-sans">
      ...
      <div className="bg-white rounded-2xl p-4 sm:p-6 border border-slate-200/80 shadow-sm space-y-4">
        <div className="flex flex-col md:flex-row gap-4 items-center justify-between">
          ...
          <div className="flex items-center gap-1.5 w-full md:w-auto overflow-x-auto pb-1 md:pb-0">
            ...
            >
              Semua Jenis ({katalogList.length})
            </button>
            <button
          ...
          <div className="flex items-center gap-2 w-full md:w-auto justify-end">
            ...
            <select
              ...
              className="text-xs p-2 rounded-lg border border-slate-200 focus:outline-none focus:ring-2 focus:ring-emerald-500 font-semibold text-slate-700"
            >
              <option value="default">Bawaan Sistem</option>
          ...
          return (
            ...
            >
              <div className="space-y-3">
                ...
                <div>
                  <h3 className="text-lg font-bold text-slate-900">{item.nama_kategori}</h3>
              ...
              <div className="mt-6 pt-4 border-t border-slate-100 flex items-end justify-between">
                <div>
                  <span className="text-[11px] text-slate-400 font-semibold block">Harga Beli Warga</span>
                ...
                <button
                  ...
                  className="px-3 py-1.5 rounded-lg bg-slate-100 hover:bg-emerald-50 hover:text-emerald-700 text-slate-600 text-xs font-bold transition flex items-center gap-1"
                >
      ...
      {filteredKatalog.length === 0 && (
        <div className="text-center py-16 bg-white rounded-3xl border border-dashed border-slate-200 space-y-3">
          ...
          <h3 className="text-base font-bold text-slate-700">Kategori sampah tidak ditemukan</h3>
          <p className="text-xs text-slate-400">Coba ubah kata kunci pencarian atau filter kategori.</p>
        </div>
      )}

      {/* Guide & Sorting Tips */}
      <div className="bg-slate-100/80 rounded-3xl p-6 sm:p-8 border border-slate-200/60">
        <h3 className="text-lg font-extrabold text-slate-800 mb-4 flex items-center gap-2">
          <Info className="w-5 h-5 text-emerald-600" />
          Panduan Penimbangan & Kualitas Sampah Desa Mekarjaya
        </h3>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-xs text-slate-600 leading-relaxed">
          <div className="bg-white p-4 rounded-xl border border-slate-200 space-y-1">
            <h4 className="font-bold text-slate-800 text-sm text-sky-800">Sampah Anorganik (Kardus, Plastik, Logam)</h4>
          ...
          <div className="bg-white p-4 rounded-xl border border-slate-200 space-y-1">
            <h4 className="font-bold text-slate-800 text-sm text-emerald-800">Sampah Organik (Pakan Maggot BSF)</h4>
